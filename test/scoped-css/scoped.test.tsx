...
// 验证完整链路：Babel 注入 → 运行时 DOM 属性 → CSS 侧 hash 与 JSX 侧 hash 一致性
// v1 特有部分移除：renderToString（v1 SSR API，v2 走 vue）与 scopedId
// 运行时机制（v1 组件边界转 scopedId prop——v2 的 scoped 是编译期
// data-v 注入 + attrs 自动落根，见 test/v2/inherit-attrs.test.tsx）
// ============================================================
