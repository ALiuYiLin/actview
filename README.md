...
- 🌐 **路由与生态**：官方路由 `@actview/router`、Vite/Babel 插件 `@actview/plugin`、脚手架 `@actview/create-cli`
...
```bash
npm install actview @actview/router @actview/jsx @actview/plugin
```
