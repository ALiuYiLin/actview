...
以下为本地实测数据（Chrome + puppeteer 驱动，15 次迭代取均值，单位 ms），**非官方结果**，仅供参考；官方结果以 [results page](https://krausest.github.io/js-framework-benchmark/index.html) 为准。

### CPU 基准（total 均值）

| 基准 | vanilla | vue | react-hooks | svelte | solid | preact-hooks | **actview** |
|---|---|---|---|---|---|---|---|
| 创建 1000 行 | 38.5 | 48.4 | 48.2 | 40.6 | 40.2 | 49.0 | **50.9** |
| 替换 1000 行 | 41.0 | 51.2 | 54.8 | 44.6 | 44.5 | 53.9 | **55.2** |
| 局部更新（每第 10 行） | 20.8 | 23.9 | 29.0 | 23.0 | 21.5 | 42.1 | **53.5** |
| 选中行高亮 | 7.5 | 8.6 | 11.1 | 12.0 | 8.8 | 27.0 | **37.9** |
| 交换两行 | 22.7 | 26.5 | 205.8 | 25.4 | 24.0 | 42.0 | **53.3** |
| 删除一行 | 17.9 | 23.2 | 20.4 | 20.1 | 19.0 | 28.1 | **35.3** |
| 创建 10000 行 | 416.9 | 526.3 | 738.9 | 450.3 | 446.8 | 556.3 | **561.4** |
| 大表追加 1000 行 | 42.8 | 51.4 | 54.3 | 44.5 | 44.2 | 55.5 | **65.1** |
| 清空 10000 行 | 15.5 | 23.5 | 31.3 | 19.2 | 21.3 | 24.0 | **27.0** |

### 内存 / 体积 / 首屏

| 基准 | vanilla | vue | react-hooks | svelte | solid | preact-hooks | **actview** |
|---|---|---|---|---|---|---|---|
| ready memory（MB） | 0.58 | 0.86 | 1.17 | 0.62 | 0.61 | 0.65 | **0.66** |
| run memory（MB） | 2.05 | 4.08 | 4.57 | 2.98 | 2.85 | 3.49 | **4.11** |
